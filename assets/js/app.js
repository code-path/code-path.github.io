...
let App = (function()
{
    ...
    self.dorna = function()
    {
        ...
        const typed = new Typed(self.selectors.dornaType, {
            loop: true,
            shuffle: true,
            strings: ['The day my life changed forever... the day I first saw you.', 'I love you, not only for what you are, but for what I am when I am with you.', 'I wish you to know that you have been the last dream of my soul.', 'I want you today, tomorrow, next week and for the rest of my life.'],
            typeSpeed: 90,
            startDelay: 100,
            showCursor: true,
